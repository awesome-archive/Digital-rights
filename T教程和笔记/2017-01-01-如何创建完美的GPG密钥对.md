...
3.  文中生成的GPG密钥只做演示之用，不是二翔子日常所用的[GPG密钥](https://2xxxxxx.blogspot.com/p/blog-page.html)；
...
`Real name:` **erxxxxxx**
`Email address:` **2xxxxxx-blog@riseup.net**
`Comment:`

    You selected this USER-ID:
        "erxxxxxx <2xxxxxx-blog@riseup.net>"
...
&lt;在此输入密码(Passphrase)&gt;
    ...
    uid                  erxxxxxx <2xxxxxx-blog@riseup.net>
...
`user@temp:~$` **gpg - -edit-key AB7BB174**
    ...
    [ultimate] (1). erxxxxxx <2xxxxxx-blog@riseup.net>
...
`is this photo correct (y/N/q)?` **y**
    ...
    user: "erxxxxxx <2xxxxxx-blog@riseup.net>"
...
`user@temp:~$` **gpg - -output revocation.cert - -gen-revoke AB7BB174**
    ...
    sec  4096R/AB7BB174 2016-09-05 erxxxxxx <2xxxxxx-blog@riseup.net>
...
`user@temp:~$` **gpg - -export-secret-keys - -armor AB7BB174 &gt; erxxxxxx\_gpg\_private.key**

创建公钥备份：

`user@temp:~$` **gpg - -export - -armor AB7BB174 &gt; erxxxxxx\_gpg\_public.key**

将*私钥*、*公钥*及*撤销证书*打包：（Windows操作系统的操作与此不同）

`user@temp:~$` **tar -cf gpg\_master\_keys.tar erxxxxxx\_gpg\*.key revocation.cert**
...
`user@temp:~$` **shred -u erxxxxxx\*.key revocation.cert**
...
`user@temp:~$` **gpg - -import subkeys**
    ...
    gpg: key AB7BB174: "erxxxxxx <2xxxxxx-blog@riseup.net>" 1 new signature
...
`[user@temp ~]$` **tar xvf gpg\_master\_keys.tar**
    ...
    erxxxxxx_gpg_private.key
    erxxxxxx_gpg_public.key
    revocation.cert
...
`[user@temp ~]$` **gpg - -import alice\_gpg\_p\*.key**
    ...
    gpg: key AB7BB174: secret key imported
    gpg: /home/user/.gnupg/trustdb.gpg: trustdb created
    gpg: key AB7BB174: public key "erxxxxxx <2xxxxxx-blog@riseup.net>" imported
    gpg: key AB7BB174: "erxxxxxx <2xxxxxx-blog@riseup.net>" 1 new signature
...
&lt;在此输入密码(Passphrase)&gt;
    ...
    pub  4096R/AB7BB174  created: 2016-09-05  expires: 2017-09-05  usage: SC  
                         trust: ultimate      validity: ultimate
    This key was revoked on 2016-09-05 by RSA key AB7BB174 erxxxxxx <2xxxxxx-blog@riseup.net>
    sub  4096R/AB64DCD1  created: 2016-09-05  expires: 2017-09-05  usage: E   
    This key was revoked on 2016-09-05 by RSA key AB7BB174 erxxxxxx <2xxxxxx-blog@riseup.net>
    sub  4096R/0D65E7C7  created: 2016-09-05  expires: 2017-09-05  usage: S   
    [ultimate] (1). erxxxxxx <2xxxxxx-blog@riseup.net>
...
之后将 ASCII文件中的内容贴到互联网上。二翔子此次[撤回密钥](https://2xxxxxx.blogspot.nl/2016/09/change-gpg-public-key-1.html)就是用了这种方法。
...
<span class="post-author vcard"> 发帖者 <span class="fn" itemprop="author" itemscope="itemscope" itemtype="http://schema.org/Person"> <a href="https://plus.google.com/105144493669632558142" class="g-profile" title="author profile"><span itemprop="name">二翔子</span></a> </span> </span> <span class="post-timestamp"> 时间： <a href="https://2xxxxxx.blogspot.com/2016/09/perfect-gpg-keypair.